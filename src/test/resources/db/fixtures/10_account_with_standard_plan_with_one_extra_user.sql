...
-- -----------------------
call sp_create_product_and_links('R', 5, 2, 1, 2, 'https://amazon.com/', 2, 'Workspace-E', @workspace_id);
call sp_create_product_and_links('S', 0, 0, 1, 0, 'https://gittigidiyor.com', 83, 'Workspace-E', @workspace_id);
