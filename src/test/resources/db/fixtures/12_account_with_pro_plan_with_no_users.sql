...
-- -----------------------
call sp_create_product_and_links('A', 1, 0, 0, 1, 'https://amazon.com/', 2, 'Workspace-G', @workspace_id);
call sp_create_product_and_links('B', 1, 0, 0, 1, 'https://ebay.com/', 12, 'Workspace-G', @workspace_id);
