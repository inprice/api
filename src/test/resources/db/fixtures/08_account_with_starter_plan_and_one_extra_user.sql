...
-- -----------------------
call sp_create_product_and_links('X', 2, 1, 1, 0, 'https://amazon.com/', 2, 'Workspace-C', @workspace_id);
call sp_create_product_and_links('Y', 4, 1, 0, 3, 'https://ebay.com/', 12, 'Workspace-C', @workspace_id);
