...
values ('Standard Plan and No Extra User', @standard_plan_id, 'FREE', now(), @one_year_later, 10, @admin_id);
...
call sp_create_product_and_links('AX-003', '3', 0, 0, 0, 0, 'https://amazon.com/', 2, 'Workspace-B', @workspace_id);

-- -----------------------
-- 2 alarms definitions for 10 entities (2 product and 8 links)
-- -----------------------
...
update link set alarm_id=last_insert_id() where (grup = 'PROBLEM' or status = 'TOBE_IMPLEMENTED') and workspace_id = @workspace_id;
