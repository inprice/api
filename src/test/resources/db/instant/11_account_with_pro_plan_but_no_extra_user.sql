...
-- account
insert into test.account (name, plan_id, status, subs_started_at, subs_renewal_at, admin_id) values ('With Pro Plan and No Extra User', @planId, 'SUBSCRIBED', now(), '2050-01-01 23:59:59', @admin_id);
