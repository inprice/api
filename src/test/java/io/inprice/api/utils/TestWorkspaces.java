...
public enum TestWorkspaces {
	...
	Without_a_plan_and_extra_user(
  	...
  	"Has one coupon and 1 User, 1 Workspace and 1 System announces. 2 Tickets and 3 Comments (1 is closed)",
  	Set.of("RB5QV6CF"),
		Map.of(
	...
	Standard_plan_and_two_extra_users(
  	...
  	"Has 5 active, 1 trying, 1 waiting and 3 problem links. 2 Tickets opened by Viewer and 1 is opened by Admin (in CLOSED status). Three workspace transactions. No alarm or coupon",
  	null,
		Map.of(
	...
	private TestWorkspaces(String name, String description, Set<String> coupons, Map<TestRoles, JSONObject> roleEmailMap) {
		this.name = name;
