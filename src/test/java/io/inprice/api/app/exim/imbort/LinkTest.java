...
public class LinkTest {
	...
	public void You_dont_have_an_active_plan() {
		JSONObject json = callTheService(TestWorkspaces.Cancelled_Standard_plan.ADMIN(), "links_2.csv");
	...
	public void Everything_must_be_ok_WITH_editor() {
		JSONObject json = callTheService(TestWorkspaces.Premium_plan_and_two_extra_users.EDITOR(), "links_1.csv");
	...
	public void Everything_must_be_ok_WITH_admin() {
		JSONObject json = callTheService(TestWorkspaces.Premium_plan_with_no_user.ADMIN(), "links_2.csv");
