...
/**
 * Tests the functionality of BrandController.upload(String csvContent) under exim
 * 
 * @author mdpinar
 * @since 2021-11-07
 */
...
public class BrandTest {
	...
	private static final String SERVICE_ENDPOINT = "/exim/brand/upload";
	...
	public void You_dont_have_an_active_plan() {
		JSONObject json = callTheService(TestWorkspaces.Cancelled_Standard_plan.ADMIN(), "brands_1.csv");
	...
	public void Everything_must_be_ok_FOR_any_kind_of_users() {
		...
		Map<TestRoles, String> roleFileMap = Map.of(
			TestRoles.ADMIN, "brands_1.csv",
			TestRoles.EDITOR, "brands_2.csv"
		);
