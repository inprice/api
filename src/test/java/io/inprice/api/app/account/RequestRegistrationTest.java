...
/**
 * Tests the functionality of AccountController.requestRegistration(RegisterDTO)
 * 
 * @author mdpinar
 * @since 2021-07-06
 */
...
public class RequestRegistrationTest {
	...
	@Test
	public void Account_name_cannot_be_empty_WITH_empty_account_name() {
		JSONObject body = new JSONObject(SAMPLE_BODY.toMap());
		body.remove("accountName");
	...
	@Test
	public void Account_name_must_be_between_3_and_70_chars_WITH_shorter_email() {
		JSONObject body = new JSONObject(SAMPLE_BODY.toMap());
		body.put("accountName", "ab");
		...
		assertEquals(400, json.getInt("status"));
    assertEquals("Account name must be between 3 - 70 chars!", json.getString("reason"));
	}

	@Test
	public void Account_name_must_be_between_3_and_70_chars_WITH_longer_email() {
		JSONObject body = new JSONObject(SAMPLE_BODY.toMap());
		body.put("accountName", RandomStringUtils.randomAlphabetic(71));
	...
	public void Already_registered_user() {
		...
		assertEquals("Already registered user! Signing up is an option for only newcomers! Please use 'Create Account' menu after login.", json.getString("reason"));
	}
