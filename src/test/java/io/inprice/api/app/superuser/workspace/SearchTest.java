...
/**
 * Tests the functionality of superuser's Workspace -> Controller.search(BaseSearchDTO)
 * 
 * @author mdpinar
 * @since 2021-07-22
 */
...
public class SearchTest {
	...
	private static final String SERVICE_ENDPOINT = "/sys/workspaces/search";
	...
	public void Everything_must_be_ok_WITH_superuser() {
		...
		JSONArray workspaceList = json.getJSONArray("data");
		assertEquals(2, workspaceList.length());
	}
