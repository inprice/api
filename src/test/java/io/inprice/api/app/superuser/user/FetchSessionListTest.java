...
/**
 * Tests the functionality of superuser's User -> Controller.fetchSessionList(Long userId)
 * 
 * @author mdpinar
 * @since 2021-07-24
 */
@RunWith(JUnit4.class)
public class FetchSessionListTest {

	private static final String SERVICE_ENDPOINT = "/sys/user/details/sessions/{userId}";
