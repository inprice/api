...
/**
 * Tests the functionality of superuser's User -> Controller.fetchWorkspaceList(Long userId)
 * 
 * @author mdpinar
 * @since 2021-07-24
 */
@RunWith(JUnit4.class)
public class FetchWorkspaceListTest {

	private static final String SERVICE_ENDPOINT = "/sys/user/workspaces/{userId}";
