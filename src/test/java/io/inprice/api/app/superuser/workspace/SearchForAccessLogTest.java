...
/**
 * Tests the functionality of superuser's Workspace -> Controller.searchForAccessLog(ALSearchDTO)
 * 
 * @author mdpinar
 * @since 2021-07-22
 */
...
public class SearchForAccessLogTest {
	...
	private static final String SERVICE_ENDPOINT = "/sys/workspace/search-logs";
	...
	@Test
	public void Workspace_id_is_missing_WITHOUT() {
