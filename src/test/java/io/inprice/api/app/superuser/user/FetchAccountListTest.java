...
/**
 * Tests the functionality of superuser's User -> Controller.fetchAccountList(Long userId)
 * 
 * @author mdpinar
 * @since 2021-07-24
 */
@RunWith(JUnit4.class)
public class FetchAccountListTest {

	private static final String SERVICE_ENDPOINT = "/sys/user/accounts/{userId}";
