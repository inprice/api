...
/**
 * Tests the functionality of superuser's User -> Controller.fetchUsedServiceList(Long userId)
 * 
 * @author mdpinar
 * @since 2021-07-24
 */
@RunWith(JUnit4.class)
public class FetchUsedServiceListTest {

	private static final String SERVICE_ENDPOINT = "/sys/user/used-services/{userId}";
