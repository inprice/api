...
/**
 * Tests the functionality of superuser's User -> Controller.deleteUsedService(Long id)
 * 
 * @author mdpinar
 * @since 2021-07-24
 */
@RunWith(JUnit4.class)
public class DeleteUsedServiceTest {

	private static final String SERVICE_ENDPOINT = "/sys/user/used-service/{id}";
	 ...
	 *	c) tries to delete used service for the user
	 */
	@Test
	public void Everything_must_be_ok_WITH_superuser() {
		...
		JSONObject usedService = data.getJSONObject(0);

		//tries to delete used service for the user
		JSONObject result = callTheService(Fixtures.SUPER_USER, usedService.getLong("id"));
