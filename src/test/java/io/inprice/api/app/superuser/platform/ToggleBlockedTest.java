...
/**
 * Tests the functionality of superuser's Platform -> Controller.toggleBlocked(id)
 * 
 * @author mdpinar
 * @since 2021-08-28
 */
@RunWith(JUnit4.class)
public class ToggleBlockedTest {

	private static final String SERVICE_ENDPOINT = "/sys/platform/toggle-blocked/{platformId}";
