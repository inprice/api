...
public interface MemberDao {
  ...
  final String COMPANY_FIELDS = 
    ", c.name as company_name, c.status as company_status, c.subs_customer_id, " +
    "c.last_status_update, c.plan_name, c.subs_renewal_at, c.currency_format, c.product_count ";
