...
public interface ProductDao {
  ...
  @SqlQuery("select id, lower(name) as name from brand where workspace_id=:workspaceId")
  @UseRowMapper(IdNameMapper.class)
  List<IdName> getBrandList(@Bind("workspaceId") Long workspaceId);
  ...
  @SqlQuery("select id, lower(name) as name from category where workspace_id=:workspaceId")
  @UseRowMapper(IdNameMapper.class)
  List<IdName> getCategoryList(@Bind("workspaceId") Long workspaceId);
