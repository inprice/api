...
public class Responses {
    ...
    public static final Response SERVER_ERROR = new Response(HttpStatus.INTERNAL_SERVER_ERROR_500, "Something went wrong in server side. We will take care of it immediately.");
