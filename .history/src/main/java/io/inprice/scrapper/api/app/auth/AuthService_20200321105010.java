...
public class AuthService {
   ...
   public ServiceResponse resetPassword(PasswordDTO dto) {
      if (dto != null) {
         if (!tokenService.isTokenInvalidated(dto.getToken())) {
            ...
            ServiceResponse res = validatePassword(dto);
            if (res.isOK()) {
               ...
               if (email != null) {
                  ...
                  if (found.isOK()) {
                     ...
                     res = userRepository.updatePassword(user.getId(), dto.getPassword());
   ...
   private ServiceResponse validatePassword(PasswordDTO dto) {
      List<String> problems = PasswordDTOValidator.verify(dto, true, false);

      if (StringUtils.isBlank(dto.getToken())) {
         problems.add("Token cannot be null!");
      } else if (tokenService.isEmailTokenExpired(dto.getToken())) {
