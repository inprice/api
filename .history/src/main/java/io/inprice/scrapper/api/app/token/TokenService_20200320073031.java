...
public class TokenService {
   ...
   Map<TokenType, String> getAccessTokens(AuthUser authUser, String ip, String userAgent) {
   ...
   Map<TokenType, String> getInvitationTokens(MemberDTO memberDTO) {
   ...
   public AuthUser extractAuthUserFromContext(Context ctx) {
      String token = clearBearerPrefix(ctx.header(Consts.Auth.AUTHORIZATION_HEADER));
      if (token != null) {
   ...
   private String clearBearerPrefix(String header) {
